...
//                             <span style={{ fontFamily: "var(--font-display)", fontSize: "10px", fontWeight: 600, letterSpacing: "0.15em", color: MOTOGP_RED, textTransform: "uppercase" }}>
//                                 MotoGP™
//                             </span>
//                         </Link>
...
//                                 letterSpacing: "0.2em", textTransform: "uppercase", color: MOTOGP_RED, marginBottom: "6px",
//                             }}>
...
//                                         borderBottom: isActive ? `2px solid ${MOTOGP_RED}` : "2px solid transparent",
...
//                 {/* Race podium cards — only shown on RAC tab */}
                    ...
                    {isUpcoming && (
                        <div style={{ paddingBottom: "20px" }}>
                            <span style={{
                                ...
                                color: MOTOGP_RED, borderBottom: `2px solid ${MOTOGP_RED}`,
                                paddingBottom: "10px",
                            }}>
            ...
            <div className="max-w-7xl mx-auto px-6 py-10">
                ...
                {isUpcoming && (
                    <div>
                            ...
                            <div style={{
                                ...
                                {[
                                    ...
                                    <div key={unit.label} style={{
                                        padding: "20px 32px",
                                        backgroundColor: i === 0 ? `${MOTOGP_RED}18` : "rgba(255,255,255,0.03)",
                                        border: "1px solid rgba(255,255,255,0.06)",
                                        borderTop: i === 0 ? `2px solid ${MOTOGP_RED}` : "2px solid rgba(255,255,255,0.08)",
                                        textAlign: "center",
                                    }}>
                                        <div style={{ fontFamily: "var(--font-display)", fontSize: "3rem", fontWeight: 800, color: i === 0 ? MOTOGP_RED : "#fff", lineHeight: 1 }}>
                                            {unit.value}
                                        </div>
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                borderBottom: "1px solid rgba(255,255,255,0.04)",
                                                borderLeft: `3px solid ${isRaceSession ? MOTOGP_RED : isSprintSession ? `${MOTOGP_RED}80` : "rgba(255,255,255,0.1)"}`,
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                ...
                                                {isRaceSession && (
                                                    <span style={{
                                                        ...
                                                        backgroundColor: MOTOGP_RED, padding: "2px 8px",
                                                    }}>
                                                        RACE
                                                    </span>
                                                )}
                                                {isSprintSession && (
                                                    <span style={{
                                                        fontFamily: "var(--font-display)", fontSize: "9px", fontWeight: 700,
                                                        letterSpacing: "0.1em", color: MOTOGP_RED,
                                                        border: `1px solid ${MOTOGP_RED}66`, padding: "2px 8px",
                                                    }}>
                                                        SPRINT
                                                    </span>
                                                )}
                        ...
                        <div style={{ marginTop: "24px", padding: "16px 20px", border: "1px solid rgba(255,255,255,0.06)", borderLeft: `3px solid ${MOTOGP_RED}44`, backgroundColor: "rgba(255,255,255,0.01)" }}>
