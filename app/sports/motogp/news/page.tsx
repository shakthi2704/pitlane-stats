...
type SourceFilter = "all" | "Autosport" | "BBC Sport" | "Crash.net"
...
const ArticleCard = ({ article, featured }: { article: Article; featured?: boolean }) => {
    ...
    return (
        <Link href={`/sports/motogp/news/${slug}`} style={{ textDecoration: "none", display: "block" }}>
            <div
                style={{
            ...
            >
                ...
                {article.imageUrl && !imgError ? (
                    ...
                    <div style={{
                        ...
                        <span style={{ fontFamily: "var(--font-display)", fontSize: "3rem", opacity: 0.08, color: sourceColor }}>
                            MG
                        </span>
                    </div>
                )}
                ...
                <div style={{ padding: "14px 16px" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                        ...
                        <span style={{ fontFamily: "var(--font-sans)", fontSize: "0.7rem", color: "rgba(255,255,255,0.25)" }}>
                            {timeAgo(article.publishedAt)}
                        </span>
                    </div>
                    <p style={{
                        fontFamily: "var(--font-display)", fontSize: featured ? "1.05rem" : "0.85rem",
                        fontWeight: 400, color: "#ffffff", margin: "0 0 8px", lineHeight: 1.3,
...
export default function MotoGPNewsPage() {
    ...
    const sources: SourceFilter[] = ["all", "Autosport", "BBC Sport", "Crash.net"]
        ...
        <div>
            ...
            <div style={{ borderBottom: "1px solid rgba(255,255,255,0.06)", padding: "48px 0 0" }}>
                <div className="max-w-7xl mx-auto px-6">
                    <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "20px", marginBottom: "20px" }}>
                        <div>
                            <p style={{ fontFamily: "var(--font-display)", fontSize: "11px", fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--accent)", marginBottom: "8px" }}>MotoGP™</p>
                            <h1 style={{
                                fontFamily: "var(--font-display)",
                            ...
                            <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.875rem", margin: 0 }}>
                                {articles.length > 0
                                    ? `${articles.length} articles from Autosport, BBC Sport & Crash.net`
                                    : "Live from Autosport, BBC Sport & Crash.net"}
                            </p>
                        </div>
                            ...
                            {sources.map(s => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        padding: "6px 12px", cursor: "pointer", border: "1px solid", transition: "all 0.2s",
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "8px", paddingBottom: "20px" }}>
                        ...
                        <span style={{ fontFamily: "var(--font-sans)", fontSize: "0.72rem", color: "rgba(255,255,255,0.5)", letterSpacing: "0.06em" }}>
                            Live feed · updates every 10 minutes
                        </span>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                {!loading && !error && filtered.length === 0 && (
                    <div style={{ padding: "80px 0", textAlign: "center" }}>
                        <p style={{ fontFamily: "var(--font-display)", fontSize: "11px", color: "rgba(255,255,255,0.3)", letterSpacing: "0.15em" }}>
                            NO ARTICLES FROM {filter.toUpperCase()}
                        </p>
                    </div>
                )}
            </div>
