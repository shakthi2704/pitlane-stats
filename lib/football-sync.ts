...
// Phase 1 competitions — active and fully synced
...
// Phase 2 — seeded as Coming Soon, no data synced yet
export const FOOTBALL_COMPETITIONS_PHASE2 = [
    { code: "BL1", name: "Bundesliga", shortName: "BL1", country: "Germany", countryCode: "GER", type: "LEAGUE", plan: "TIER_TWO" },
    { code: "SA", name: "Serie A", shortName: "SA", country: "Italy", countryCode: "ITA", type: "LEAGUE", plan: "TIER_TWO" },
    { code: "FL1", name: "Ligue 1", shortName: "FL1", country: "France", countryCode: "FRA", type: "LEAGUE", plan: "TIER_TWO" },
    { code: "EL", name: "Europa League", shortName: "EL", country: null, countryCode: null, type: "CUP", plan: "TIER_TWO" },
    { code: "ECL", name: "Conference League", shortName: "ECL", country: null, countryCode: null, type: "CUP", plan: "TIER_TWO" },
] as const
...
export async function seedCompetitions() {
    const all = [...FOOTBALL_COMPETITIONS_PHASE1, ...FOOTBALL_COMPETITIONS_PHASE2]
    let seeded = 0
...
export async function syncSquads(competitionCode: string) {
    ...
    try {
        ...
        for (const team of data.teams) {
            ...
            // Squad players come nested on the team object from /teams endpoint
        ...
        return { teams: data.teams.length }
    } catch (err: unknown) {
